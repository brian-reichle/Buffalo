...
namespace Buffalo.Generated.Byte
{
		...
		where TToken : class
	{
		...
		//   Offsets            : 18
		//   Actions            : 120
		// Memory Footprint     : 243 bytes
		//   Boundries          : 58 bytes
		//   Classifications    : 29 bytes
		//   Transitions        : 138 bytes
		//   Token Types        : 18 bytes
		// Assembly Footprint   : 194 bytes (79.84%)
		protected AutoScanner(string expressionString)
		{
			...
			_charClassification = new byte[29]
			{
				0, 4, 0, 4, 0, 15, 1, 3, 14, 0, 2, 16, 13, 8, 0, 9,
				0, 6, 9, 12, 5, 9, 11, 9, 10, 9, 7, 9, 0,
			};
			_transitionTable = Expand("Buffalo.Core.Test.Lexer.Generation.ElementSize.Byte.0.table");
		...
		[DebuggerBrowsable(DebuggerBrowsableState.Never)]
		readonly byte[] _charClassification;
		[DebuggerBrowsable(DebuggerBrowsableState.Never)]

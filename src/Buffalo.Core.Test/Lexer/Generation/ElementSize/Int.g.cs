...
namespace Buffalo.Generated.Int
{
		...
		where TToken : class
	{
		...
		//   Offsets            : 18
		//   Actions            : 120
		// Memory Footprint     : 798 bytes
		//   Boundries          : 58 bytes
		//   Classifications    : 116 bytes
		//   Transitions        : 552 bytes
		//   Token Types        : 72 bytes
		// Assembly Footprint   : 602 bytes (75.44%)
		protected AutoScanner(string expressionString)
		{
			...
			_charClassification = new int[29]
			{
				0, 4, 0, 4, 0, 15, 1, 3, 14, 0, 2, 16, 13, 8, 0, 9,
				0, 6, 9, 12, 5, 9, 11, 9, 10, 9, 7, 9, 0,
			};
			_transitionTable = Expand("Buffalo.Core.Test.Lexer.Generation.ElementSize.Int.0.table");
		...
		static int[] Expand(string resourceName)
		{
		...
		[DebuggerBrowsable(DebuggerBrowsableState.Never)]
		readonly int[] _charClassification;
		[DebuggerBrowsable(DebuggerBrowsableState.Never)]

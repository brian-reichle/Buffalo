...
namespace Buffalo.Generated.MultiTable
{
		...
		where TToken : class
	{
		...
		protected AutoScanner(string expressionString)
		{
			...
			_transitionTable_0 = Extract("Buffalo.Core.Test.Lexer.Generation.Multi.MultiTable.0.table");
			...
			_transitionTable_1 = Expand("Buffalo.Core.Test.Lexer.Generation.Multi.MultiTable.1.table");
		...
		void SetForState(ScannerState state)
		{
			switch (state)
			{
				case ScannerState.INITIAL:
					_transitionTable = _transitionTable_1;
					_tokenTypes = _tokenTypes_1;
					_charClassificationBoundries = _charClassificationBoundries_1;
					_charClassification = _charClassification_1;
					break;

				case ScannerState.Other:
					_transitionTable = _transitionTable_0;
					_tokenTypes = _tokenTypes_0;
					_charClassificationBoundries = _charClassificationBoundries_0;
					_charClassification = _charClassification_0;
					break;
		...
		[DebuggerBrowsable(DebuggerBrowsableState.Never)]
		readonly char[] _charClassificationBoundries_0;
		[DebuggerBrowsable(DebuggerBrowsableState.Never)]
		readonly ushort[] _charClassification_0;
		[DebuggerBrowsable(DebuggerBrowsableState.Never)]
		readonly ushort[] _transitionTable_0;
		[DebuggerBrowsable(DebuggerBrowsableState.Never)]
		readonly TokenType[] _tokenTypes_0;

		[DebuggerBrowsable(DebuggerBrowsableState.Never)]
		readonly char[] _charClassificationBoundries_1;
		[DebuggerBrowsable(DebuggerBrowsableState.Never)]
		readonly ushort[] _charClassification_1;
		[DebuggerBrowsable(DebuggerBrowsableState.Never)]
		readonly ushort[] _transitionTable_1;
		[DebuggerBrowsable(DebuggerBrowsableState.Never)]
		readonly TokenType[] _tokenTypes_1;
	}
}

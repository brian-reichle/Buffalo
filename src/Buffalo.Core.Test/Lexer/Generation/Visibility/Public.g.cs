...
{
	public abstract class AutoScanner<TToken> : IEnumerable<TToken>, IEnumerator<TToken>
		where TToken : class
	{
		...
		protected AutoScanner(string expressionString)
		{
			...
			_transitionTable = Expand("Buffalo.Core.Test.Lexer.Generation.Visibility.Public.0.table");

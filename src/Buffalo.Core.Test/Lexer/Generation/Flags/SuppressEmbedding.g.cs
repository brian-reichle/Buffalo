...
namespace Buffalo.Generated.SuppressEmbedding
{
		...
		where TToken : class
	{
		...
		protected AutoScanner(string expressionString)
		{
			...
			_transitionTable = Expand(new ushort[89]
			{
				138, 65535, 18, 99, 65535, 6, 0, 60, 60, 99, 121, 47, 34, 60, 86, 73,
				112, 0, 8, 3, 4, 18, 17, 15, 15, 12, 15, 15, 15, 16, 6, 5,
				7, 65535, 5, 0, 65535, 6, 15, 10, 15, 65535, 5, 0, 15, 15, 9, 65535,
				5, 15, 65535, 5, 0, 65535, 8, 15, 65535, 5, 0, 65535, 5, 15, 14, 15,
				15, 65535, 5, 0, 15, 13, 65535, 6, 15, 65535, 8, 0, 11, 65535, 8, 0,
				18, 65535, 12, 0, 12, 65535, 7, 0, 2,
			});

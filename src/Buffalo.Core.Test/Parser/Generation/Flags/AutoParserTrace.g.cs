...
namespace Buffalo.Generated.Trace
{
	...
	internal abstract class AutoParser
	{
		...
		public string Trace
		{
			get { return _traceBuilder == null ? string.Empty : _traceBuilder.ToString(); }
		}
		...
		void WriteTrace(int state, TokenType type, string action)
		{
			if (_traceBuilder == null)
			{
				_traceBuilder = new StringBuilder();
				_traceBuilder.AppendLine();
				_traceBuilder.AppendLine("State  | Type                 | Action");
				_traceBuilder.AppendLine("-------+----------------------+------------");
			}
			...
			_traceBuilder.Append(' ', 6 - stateStr.Length);
			_traceBuilder.Append(stateStr);
			_traceBuilder.Append(" | ");
			_traceBuilder.Append(typeStr);
			_traceBuilder.Append(' ', 20 - typeStr.Length);
			_traceBuilder.Append(" | ");
			_traceBuilder.AppendLine(action);
		}

		string ReductionString(int reductionId)
		{
			switch (reductionId)
			{
				case 14: return "<Equation> -> <Expression> <ComparisonOp> <Expression>";
				case 4: return "<ComparisonOp> -> EqualTo";
				case 9: return "<ComparisonOp> -> NotEqualTo";
				case 7: return "<ComparisonOp> -> LessThan";
				case 8: return "<ComparisonOp> -> LessThanOrEqualTo";
				case 5: return "<ComparisonOp> -> GreaterThan";
				case 6: return "<ComparisonOp> -> GreaterThanOrEqualTo";
				case 15: return "<Expression> -> <Expression> <TermOp> <Term>";
				case 0: return "<Expression> -> <Term>";
				case 10: return "<TermOp> -> Add";
				case 11: return "<TermOp> -> Subtract";
				case 16: return "<Term> -> <Term> <FactorOp> <Factor>";
				case 2: return "<Term> -> <Factor>";
				case 13: return "<FactorOp> -> Multiply";
				case 12: return "<FactorOp> -> Divide";
				case 17: return "<Factor> -> <Value> Power <Value>";
				case 1: return "<Factor> -> <Value>";
				case 3: return "<Value> -> Number";
				case 18: return "<Value> -> OpenParen <Expression> CloseParen";
				default: throw new InvalidOperationException("unknown reduction");
			}
		}
		...
		{
			return Expand("Buffalo.Core.Test.Parser.Generation.Flags.AutoParserTrace.table");
		}
	}
}

...
namespace Buffalo.Generated.Int
{
	...
	internal abstract class AutoParser
	{
		...
		//   Goto Offsets      : 11
		//   Actions           : 113
		// Memory Footprint    : 608 bytes
		// Assembly Footprint  : 512 bytes (84.21%)
		...
		static int[] GetTransitionTable()
		{
			return Expand("Buffalo.Core.Test.Parser.Generation.ElementSize.AutoParserInt.table");
		}
	}
}
